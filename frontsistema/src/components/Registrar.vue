<template>
<div class="vh-100">
    <h1 class="display-1 text-center text-white">Registro de nuevo usuario</h1>
    <form class="form-group text-white d-grid gap-4 container form-w p-3" @submit.prevent="registrar">
        <label>Nombre:</label>
        ...
        <div class="d-flex justify-content-center">
            <button class="btn btn-primary px-3" type="submit">Registrarme</button>
        </div>
    </form>
</div>
</template>
...
export default {
  ...
  methods: {
      registrar() {
        axios({
              url: 'http://127.0.0.1:8081/auth/users/',
